...
locals {
  ...
  service_name = "Demo of conditional expression"
  owner        = "Samy"
  common_tags = {
  ...
  # The expressions assigned to local value names can either be simple constants or can be more complex expressions that transform 
  # or combine values from elsewhere in the module.
